...
if __name__ == '__main__':
    ...
    instrumentCmd = "adb shell am instrument -w -e class {}#{} cn.ninegame.gamemanager/android.test.InstrumentationTestRunner".format(constant.instrument_class,constant.instrument_function)
